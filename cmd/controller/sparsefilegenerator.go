...
const (
	/*ENV_SPARSE_FILE_DIR - if it specified as a environment variable,
	a Sparse file with specified size (SPARSE_FILE_SIZE) will
	be created and an associated Disk CR will be added to Kubernetes.*/
