...
var storagepoolsResource = schema.GroupVersionResource{Group: "ndm", Version: "v1alpha1", Resource: "storagepools"}

var storagepoolsKind = schema.GroupVersionKind{Group: "ndm", Version: "v1alpha1", Kind: "StoragePool"}
