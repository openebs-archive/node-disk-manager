...
var storagepoolclaimsResource = schema.GroupVersionResource{Group: "ndm", Version: "v1alpha1", Resource: "storagepoolclaims"}

var storagepoolclaimsKind = schema.GroupVersionKind{Group: "ndm", Version: "v1alpha1", Kind: "StoragePoolClaim"}
