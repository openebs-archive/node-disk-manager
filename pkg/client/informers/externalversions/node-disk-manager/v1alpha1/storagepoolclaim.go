...
import (
	...
	node_disk_manager_v1alpha1 "github.com/openebs/node-disk-manager/pkg/apis/node-disk-manager/v1alpha1"
	...
	v1alpha1 "github.com/openebs/node-disk-manager/pkg/client/listers/node-disk-manager/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NdmV1alpha1().StoragePoolClaims().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NdmV1alpha1().StoragePoolClaims().Watch(options)
			},
		},
		&node_disk_manager_v1alpha1.StoragePoolClaim{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storagePoolClaimInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&node_disk_manager_v1alpha1.StoragePoolClaim{}, f.defaultInformer)
}
