	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.NdmV1alpha1().StoragePools().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NdmV1alpha1().StoragePools().Watch(options)
			},
		},
		&node_disk_manager_v1alpha1.StoragePool{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *storagePoolInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&node_disk_manager_v1alpha1.StoragePool{}, f.defaultInformer)
}
