...
// 	// check if crd exists,
// 	_, err := sc.apiExtClient.ApiextensionsV1beta1().CustomResourceDefinitions().Get(context.Background(), crdName, v1.GetOptions{})
...
// 		Delete(context.Background(), crdName, *deleteOptions); err != nil {
// 		return err
// 	}
// 	return err
// }
