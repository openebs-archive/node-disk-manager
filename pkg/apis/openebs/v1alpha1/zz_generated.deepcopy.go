...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MountInformation) DeepCopyInto(out *MountInformation) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MountInformation.
func (in *MountInformation) DeepCopy() *MountInformation {
	if in == nil {
		return nil
	}
	out := new(MountInformation)
	in.DeepCopyInto(out)
	return out
}
