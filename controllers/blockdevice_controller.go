...
func (r *BlockDeviceReconciler) SetupWithManager(mgr ctrl.Manager) error {
	...
	return ctrl.NewControllerManagedBy(mgr).
		For(&openebsv1alpha1.BlockDevice{}).
		Complete(r)
}

func (r *BlockDeviceReconciler) updateBDStatus(state openebsv1alpha1.DeviceClaimState, instance *openebsv1alpha1.BlockDevice) error {
